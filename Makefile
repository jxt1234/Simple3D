...
gputest.out:  build/gltest_GLTest.o build/gltest_GLBitmapWorkTest.o build/gltest_GLScalePSNRTest.o build/gltest_GLCubicTest.o build/gltest_GLFilterTest.o build/gltest_GLFactoryTest.o build/gltest_GLFractionByGLTest.o build/gltest_opengltest_main.o build/gltest_GLWorkThreadTest.o libglsl.so
