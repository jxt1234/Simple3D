...
gputest.out:  build/gltest_GLTest.o build/gltest_GLBitmapWorkTest.o build/gltest_GLFilterTest.o build/gltest_GLFactoryTest.o build/gltest_GLFractionByGLTest.o build/gltest_opengltest_main.o libglsl.so
	g++  -O3 -fPIC -o gputest.out  build/gltest_GLTest.o build/gltest_GLBitmapWorkTest.o build/gltest_GLFilterTest.o build/gltest_GLFactoryTest.o build/gltest_GLFractionByGLTest.o build/gltest_opengltest_main.o  -lfreeimage ./libglsl.so -lGLEW -lGL -lglut ${SELF_VARIABLES}
