...
libglsl.so:  build/src_core_GLBmp.o build/src_core_GLDepthBuffer.o build/src_core_GLRasterization.o build/src_core_weightTable.o build/src_fragment_GLAbstractRasterizatedVarying.o build/src_fragment_GLLightFunction.o build/src_fragment_GLWritePixels.o build/src_fragment_texture2D.o build/src_GL_GLAutoFbo.o build/src_GL_GLAutoProgram.o build/src_GL_GLBezier.o build/src_GL_GLBiCubicCurveObj.o build/src_GL_GLBicubicWork.o build/src_GL_GLBitmapWork.o build/src_GL_GLBitmapWorkFactory.o build/src_GL_GLCamera.o build/src_GL_GLCurveObject.o build/src_GL_GLCurveObjectFactory.o build/src_GL_GLFilterWork.o build/src_GL_GLFraction.o build/src_GL_GLInWork.o build/src_GL_GLLightCurveObject.o build/src_GL_GLLightScene.o build/src_GL_GLMixWork.o build/src_GL_GLMultiPassWork.o build/src_GL_GLProgram.o build/src_GL_GLScene.o build/src_GL_GLSquareObjectCreator.o build/src_GL_GLTexture.o build/src_GL_GLTexture1Obj.o build/src_GL_GLTextureWork.o build/src_GL_GLvboBuffer.o build/src_GL_GLWorkThread.o build/src_math_AbstractPoint.o build/src_math_BasicFunctionDeter.o build/src_math_FormulaTree.o build/src_math_GLMatrix.o build/src_math_GLSphere.o build/src_math_GLVector.o build/src_package_fragment.o build/src_platform_GLContext.o build/src_platform_GLLock.o build/src_transform_ColorMover.o build/src_transform_GLBasicTransform.o build/src_transform_GLFragPicture.o build/src_transform_SceneNewton.o build/src_utils_GLThread.o build/src_utils_GP_Clock.o build/src_utils_GPRandom.o build/src_vertex_GL_Normal.o build/src_vertex_GL_position.o build/src_vertex_GLAbstractVarying.o build/src_vertex_GLVectorVarying.o build/glsl_AllShader.o build/src_utils_debug.o 
	g++  -O3 -fPIC --share  -o libglsl.so  build/src_core_GLBmp.o build/src_core_GLDepthBuffer.o build/src_core_GLRasterization.o build/src_core_weightTable.o build/src_fragment_GLAbstractRasterizatedVarying.o build/src_fragment_GLLightFunction.o build/src_fragment_GLWritePixels.o build/src_fragment_texture2D.o build/src_GL_GLAutoFbo.o build/src_GL_GLAutoProgram.o build/src_GL_GLBezier.o build/src_GL_GLBiCubicCurveObj.o build/src_GL_GLBicubicWork.o build/src_GL_GLBitmapWork.o build/src_GL_GLBitmapWorkFactory.o build/src_GL_GLCamera.o build/src_GL_GLCurveObject.o build/src_GL_GLCurveObjectFactory.o build/src_GL_GLFilterWork.o build/src_GL_GLFraction.o build/src_GL_GLInWork.o build/src_GL_GLLightCurveObject.o build/src_GL_GLLightScene.o build/src_GL_GLMixWork.o build/src_GL_GLMultiPassWork.o build/src_GL_GLProgram.o build/src_GL_GLScene.o build/src_GL_GLSquareObjectCreator.o build/src_GL_GLTexture.o build/src_GL_GLTexture1Obj.o build/src_GL_GLTextureWork.o build/src_GL_GLvboBuffer.o build/src_GL_GLWorkThread.o build/src_math_AbstractPoint.o build/src_math_BasicFunctionDeter.o build/src_math_FormulaTree.o build/src_math_GLMatrix.o build/src_math_GLSphere.o build/src_math_GLVector.o build/src_package_fragment.o build/src_platform_GLContext.o build/src_platform_GLLock.o build/src_transform_ColorMover.o build/src_transform_GLBasicTransform.o build/src_transform_GLFragPicture.o build/src_transform_SceneNewton.o build/src_utils_GLThread.o build/src_utils_GP_Clock.o build/src_utils_GPRandom.o build/src_vertex_GL_Normal.o build/src_vertex_GL_position.o build/src_vertex_GLAbstractVarying.o build/src_vertex_GLVectorVarying.o build/glsl_AllShader.o build/src_utils_debug.o  -lfreeimage  ${SELF_VARIABLES}
...
build/src_GL_GLInWork.o : src/GL/GLInWork.cpp   ${ALL_INCLUESlibglsl.so}
	g++ -O3 -fPIC -o build/src_GL_GLInWork.o -c src/GL/GLInWork.cpp -Iinclude 
...
test.out:  build/test_GLBmpTest.o build/test_GLFragTest.o build/test_GLProjectionTest.o build/test_GLRasterBasic.o build/test_GLRotateTest.o build/test_GLSingleLightTest.o build/test_GLTest.o build/test_main.o libglsl.so
	g++  -O3 -fPIC -o test.out  build/test_GLBmpTest.o build/test_GLFragTest.o build/test_GLProjectionTest.o build/test_GLRasterBasic.o build/test_GLRotateTest.o build/test_GLSingleLightTest.o build/test_GLTest.o build/test_main.o  -lfreeimage ./libglsl.so -lGL -lGLEW ${SELF_VARIABLES}
...
gputest.out:  build/gltest_GLBitmapWorkTest.o build/gltest_GLCubicTest.o build/gltest_GLFactoryTest.o build/gltest_GLFilterTest.o build/gltest_GLFractionByGLTest.o build/gltest_GLMixFractionTest.o build/gltest_GLScalePSNRTest.o build/gltest_GLTest.o build/gltest_GLWorkThreadTest.o build/gltest_opengltest_main.o libglsl.so
	g++  -O3 -fPIC -o gputest.out  build/gltest_GLBitmapWorkTest.o build/gltest_GLCubicTest.o build/gltest_GLFactoryTest.o build/gltest_GLFilterTest.o build/gltest_GLFractionByGLTest.o build/gltest_GLMixFractionTest.o build/gltest_GLScalePSNRTest.o build/gltest_GLTest.o build/gltest_GLWorkThreadTest.o build/gltest_opengltest_main.o  -lfreeimage ./libglsl.so -lGLEW -lGL -lglut ${SELF_VARIABLES}
