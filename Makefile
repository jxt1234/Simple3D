...
ALL_INCLUESlibglsl.so= include/core/GLBmp.h include/core/GLDepthBuffer.h include/core/GLRasterization.h include/fragment/GL_FragTexcord.h include/fragment/GLAbstractRasterizatedVarying.h include/fragment/GL_FragPosition.h include/fragment/GLLightFunction.h include/fragment/GL_vPosition.h include/fragment/GLWritePixels.h include/fragment/GL_FragColor.h include/fragment/GLTexture2D.h include/math/GLVector.h include/math/GLMatrix4.h include/math/GLSphere.h include/math/GLCurveSurface.h include/package/vertex.h include/package/basic.h include/package/fragment.h include/package/package.h include/transform/GLFragPicture.h include/transform/GLBasicTransform.h include/utils/RefCount.h include/utils/debug.h include/vertex/GLVectorVarying.h include/vertex/GL_texcord.h include/vertex/GLAbstractVarying.h include/vertex/GL_Normal.h include/vertex/GL_position.h include/display/GLvboBuffer.h include/display/GLProgram.h include/display/GLTexture.h include/display/debug.h include/display/GLObject.h include/display/GLCurveObject.h include/display/head.h include/display/GLScene.h

libglsl.so:  build/core_weightTable.o build/core_GLBmp.o build/core_GLRasterization.o build/core_GLDepthBuffer.o build/fragment_GLWritePixels.o build/fragment_GLLightFunction.o build/fragment_GLAbstractRasterizatedVarying.o build/fragment_texture2D.o build/math_GLMatrix.o build/math_GLVector.o build/math_GLSphere.o build/package_fragment.o build/transform_GLBasicTransform.o build/transform_ColorMover.o build/transform_SceneNewton.o build/transform_GLFragPicture.o build/vertex_GLAbstractVarying.o build/vertex_GL_position.o build/vertex_GL_Normal.o build/vertex_GLVectorVarying.o build/display_gles2_GLProgram.o build/display_gles2_GLTexture.o build/display_gles2_GLvboBuffer.o build/display_GLCurveObject.o build/display_GLProgram.o build/utils_debug.o 
	g++  -O3 --share  -o libglsl.so  build/core_weightTable.o build/core_GLBmp.o build/core_GLRasterization.o build/core_GLDepthBuffer.o build/fragment_GLWritePixels.o build/fragment_GLLightFunction.o build/fragment_GLAbstractRasterizatedVarying.o build/fragment_texture2D.o build/math_GLMatrix.o build/math_GLVector.o build/math_GLSphere.o build/package_fragment.o build/transform_GLBasicTransform.o build/transform_ColorMover.o build/transform_SceneNewton.o build/transform_GLFragPicture.o build/vertex_GLAbstractVarying.o build/vertex_GL_position.o build/vertex_GL_Normal.o build/vertex_GLVectorVarying.o build/display_gles2_GLProgram.o build/display_gles2_GLTexture.o build/display_gles2_GLvboBuffer.o build/display_GLCurveObject.o build/display_GLProgram.o build/utils_debug.o  -lfreeimage  ${SELF_VARIABLES}
...
build/display_gles2_GLProgram.o : src/display/gles2/GLProgram.cpp ${ALL_INCLUESlibglsl.so}
	g++ -O3 -o build/display_gles2_GLProgram.o -c src/display/gles2/GLProgram.cpp -Iinclude 
build/display_gles2_GLTexture.o : src/display/gles2/GLTexture.cpp ${ALL_INCLUESlibglsl.so}
	g++ -O3 -o build/display_gles2_GLTexture.o -c src/display/gles2/GLTexture.cpp -Iinclude 
build/display_gles2_GLvboBuffer.o : src/display/gles2/GLvboBuffer.cpp ${ALL_INCLUESlibglsl.so}
	g++ -O3 -o build/display_gles2_GLvboBuffer.o -c src/display/gles2/GLvboBuffer.cpp -Iinclude 
build/display_GLCurveObject.o : src/display/GLCurveObject.cpp ${ALL_INCLUESlibglsl.so}
	g++ -O3 -o build/display_GLCurveObject.o -c src/display/GLCurveObject.cpp -Iinclude 
build/display_GLProgram.o : src/display/GLProgram.cpp ${ALL_INCLUESlibglsl.so}
	g++ -O3 -o build/display_GLProgram.o -c src/display/GLProgram.cpp -Iinclude 
