...
build/GL_GLSquareObjectCreator.o : src/GL/GLSquareObjectCreator.cpp ${ALL_INCLUESlibglsl.so}
	g++ -O3 -fPIC -o build/GL_GLSquareObjectCreator.o -c src/GL/GLSquareObjectCreator.cpp -Iinclude 
