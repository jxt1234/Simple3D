...
build/GL_gles2_GLProgram.o : src/GL/gles2/GLProgram.cpp ${ALL_INCLUESlibglsl.so}
	g++ -O3 -o build/GL_gles2_GLProgram.o -c src/GL/gles2/GLProgram.cpp -Iinclude 
build/GL_gles2_GLTexture.o : src/GL/gles2/GLTexture.cpp ${ALL_INCLUESlibglsl.so}
	g++ -O3 -o build/GL_gles2_GLTexture.o -c src/GL/gles2/GLTexture.cpp -Iinclude 
build/GL_gles2_GLvboBuffer.o : src/GL/gles2/GLvboBuffer.cpp ${ALL_INCLUESlibglsl.so}
	g++ -O3 -o build/GL_gles2_GLvboBuffer.o -c src/GL/gles2/GLvboBuffer.cpp -Iinclude 
build/GL_GLCurveObject.o : src/GL/GLCurveObject.cpp ${ALL_INCLUESlibglsl.so}
	g++ -O3 -o build/GL_GLCurveObject.o -c src/GL/GLCurveObject.cpp -Iinclude 
build/GL_GLBezier.o : src/GL/GLBezier.cpp ${ALL_INCLUESlibglsl.so}
	g++ -O3 -o build/GL_GLBezier.o -c src/GL/GLBezier.cpp -Iinclude 
build/GL_GLProgram.o : src/GL/GLProgram.cpp ${ALL_INCLUESlibglsl.so}
	g++ -O3 -o build/GL_GLProgram.o -c src/GL/GLProgram.cpp -Iinclude 
...
test.out:  build/test_GLTest.o build/test_GLRotateTest.o build/test_GLSingleLightTest.o build/test_GLBmpTest.o build/test_GLRasterBasic.o build/test_GLProjectionTest.o build/test_GLFragTest.o build/main.o libglsl.so
	g++  -O3 -o test.out  build/test_GLTest.o build/test_GLRotateTest.o build/test_GLSingleLightTest.o build/test_GLBmpTest.o build/test_GLRasterBasic.o build/test_GLProjectionTest.o build/test_GLFragTest.o build/main.o  -lfreeimage ./libglsl.so -lGLEW -lGL ${SELF_VARIABLES}
...
display.out:  build/display_main.o libglsl.so
	g++  -O3 -o display.out  build/display_main.o  -lfreeimage ./libglsl.so -lGLEW -lGL -lglut -lm -lX11 ${SELF_VARIABLES}
build/display_main.o : ./display_main.cpp ${ALL_INCLUESdisplay.out}
	g++ -O3 -o build/display_main.o -c ./display_main.cpp -Iinclude 
