...
build/src_core_GLGrayBitmap.o : src/core/GLGrayBitmap.cpp   ${ALL_INCLUESlibglsl.so}
	g++ -std=c++11 -O3 -fPIC -o build/src_core_GLGrayBitmap.o -c src/core/GLGrayBitmap.cpp -Iinclude 
...
test.out:  build/test_GLBmpTest.o build/test_GLFragTest.o build/test_GLGrayTest.o build/test_GLProjectionTest.o build/test_GLRasterBasic.o build/test_GLRotateTest.o build/test_GLSingleLightTest.o build/test_GLTest.o build/test_main.o libglsl.so
	g++ -std=c++11  -O3 -fPIC -o test.out  build/test_GLBmpTest.o build/test_GLFragTest.o build/test_GLGrayTest.o build/test_GLProjectionTest.o build/test_GLRasterBasic.o build/test_GLRotateTest.o build/test_GLSingleLightTest.o build/test_GLTest.o build/test_main.o  ./libglsl.so ${SELF_VARIABLES}
...
build/test_GLGrayTest.o : test/GLGrayTest.cpp libglsl.so  ${ALL_INCLUEStest.out}
	g++ -std=c++11 -O3 -fPIC -o build/test_GLGrayTest.o -c test/GLGrayTest.cpp -Iinclude 
