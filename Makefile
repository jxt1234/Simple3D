...
build/GL_GLFragmentWork.o : src/GL/GLFragmentWork.cpp ${ALL_INCLUESlibglsl.so}
	g++ -O3 -fPIC -o build/GL_GLFragmentWork.o -c src/GL/GLFragmentWork.cpp -Iinclude 
