...
build/src_core_GLDynamicBitmap.o : src/core/GLDynamicBitmap.cpp   ${ALL_INCLUESlibglsl.so}
	g++ -std=c++11 -O3 -fPIC -o build/src_core_GLDynamicBitmap.o -c src/core/GLDynamicBitmap.cpp -Iinclude -I../Genetic-Program-Frame/include/
...
build/src_core_GLRect.o : src/core/GLRect.cpp   ${ALL_INCLUESlibglsl.so}
	g++ -std=c++11 -O3 -fPIC -o build/src_core_GLRect.o -c src/core/GLRect.cpp -Iinclude -I../Genetic-Program-Frame/include/
...
build/src_GL_GLShaderFactory.o : src/GL/GLShaderFactory.cpp   ${ALL_INCLUESlibglsl.so}
	g++ -std=c++11 -O3 -fPIC -o build/src_GL_GLShaderFactory.o -c src/GL/GLShaderFactory.cpp -Iinclude -I../Genetic-Program-Frame/include/
...
build/src_utils_ALFileStream.o : src/utils/ALFileStream.cpp   ${ALL_INCLUESlibglsl.so}
	g++ -std=c++11 -O3 -fPIC -o build/src_utils_ALFileStream.o -c src/utils/ALFileStream.cpp -Iinclude -I../Genetic-Program-Frame/include/
  
build/src_utils_ALStream.o : src/utils/ALStream.cpp   ${ALL_INCLUESlibglsl.so}
	g++ -std=c++11 -O3 -fPIC -o build/src_utils_ALStream.o -c src/utils/ALStream.cpp -Iinclude -I../Genetic-Program-Frame/include/
...
ALL_INCLUEScolor_count.out=

color_count.out:  build/color_count.o libglsl.so
	g++ -std=c++11  -O3 -fPIC   ./libglsl.so -o color_count.out  build/color_count.o ${SELF_VARIABLES}
build/color_count.o : color_count.cpp libglsl.so  ${ALL_INCLUEScolor_count.out}
	g++ -std=c++11 -O3 -fPIC -o build/color_count.o -c color_count.cpp -Iinclude -I../Genetic-Program-Frame/include/
